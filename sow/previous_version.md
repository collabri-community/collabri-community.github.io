...
# Slot: previous_version 


_IRI of the immediately prior version of this element._





URI: [pav:previousVersion](http://purl.org/pav/previousVersion)
...
| ---  | ---  |
| self | pav:previousVersion |
| native | sow:previous_version |
