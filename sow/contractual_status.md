...
URI: [sow:contractual_status](https://w3id.org/collabri/sow/contractual_status)
...
| [Trackable](Trackable.md) | Dual-axis status for any contractually-managed element |  no  |
...
| ---  | ---  |
| self | sow:contractual_status |
| native | sow:contractual_status |
